...
const uint16_t adc_channel0 = 0;
const uint16_t adc_channel1 = 1;
const uint16_t adc_channel2 = 2;
const uint16_t adc_channel3 = 3;
const uint16_t adc_channel4 = 4;
const uint16_t adc_channel5 = 5;
const uint16_t adc_channel6 = 6;
const uint16_t adc_channel7 = 7;
