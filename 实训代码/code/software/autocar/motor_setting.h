...
#define A_PWM_EN PWM1_BASE
#define A_PWM_PERIOD PWM1_BASE+1
#define A_PWM_DUTY1 PWM1_BASE+2
#define A_PWM_DUTY2 PWM1_BASE+3
#define A_PWM_PHASE1 PWM1_BASE+4
#define A_PWM_PHASE2 PWM1_BASE+5
