...
void right_motor_setting(unsigned long phase1, unsigned long duty1,unsigned long phase2, unsigned long duty2,
		unsigned long period,unsigned long enable)
{
	unsigned long * pwm_en= (unsigned long *)AN_PWM_EN;
	unsigned long * pwm_period=(unsigned long *)AN_PWM_PERIOD;
	unsigned long * pwm_phase1=(unsigned long *)AN_PWM_PHASE1;
	unsigned long * pwm_phase2=(unsigned long *)AN_PWM_PHASE2;
	unsigned long * pwm_duty1=(unsigned long *)AN_PWM_DUTY1;
	unsigned long * pwm_duty2=(unsigned long *)AN_PWM_DUTY2;
