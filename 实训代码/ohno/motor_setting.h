...
#define AN_PWM_EN PWM1_BASE
#define AN_PWM_PERIOD PWM1_BASE+1
#define AN_PWM_DUTY1 PWM1_BASE+2
#define AN_PWM_DUTY2 PWM1_BASE+3
#define AN_PWM_PHASE1 PWM1_BASE+4
#define AN_PWM_PHASE2 PWM1_BASE+5
